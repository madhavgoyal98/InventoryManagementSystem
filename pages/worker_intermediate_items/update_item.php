		...
		<form action="<?php echo('update_item.php?id='.$id.''); ?>" method="post">
			<table class='table table-hover table-responsive table-bordered' style="width: 100%">
				...
				<tr>
					...
					<td><input type='text' name='name' value='<?php echo($im_details[0]); ?>' class='form-control' readonly></td>
				</tr>

				<tr>
					<td style="width: 30%">Quantity</td>
					<td><input type='number' name='quantity' value='<?php echo($im_details[1]); ?>' class='form-control' maxlength="11" min='0' oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);' required></td>
				</tr>
				
				<tr>
					<td style="width: 30%">Measuring Unit</td>
					<td><input type='text' name='measuring' value='<?php echo($im_details[2]); ?>' class='form-control' readonly></td>
				</tr>
